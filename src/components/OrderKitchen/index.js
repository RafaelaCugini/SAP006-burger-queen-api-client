...
export function OrderKitchen({
    ...
    return (
        <div className="kitchen-wrap">
                                    ...
                                    <div className="orderWrap">
                                        <div className="headerOrder">
                                            ...
                                            <p className="timeOrder">
                                                Order made on {convertDate(data.createdAt)} at {convertTime(data.createdAt)} </p>
                                        </div>
                                                ...
                                                {data.Products.map((data, id) => {
                                                    return (
                                                        <ul className="listProductOrder" key={id}>
                                                            ...
                                                            <div className="quantityItem"> The amount: {data.qtd}
            ...
            ) : <p className="withoutOrders">No orders at the moment!</p>
            }
        </div >
    )
}